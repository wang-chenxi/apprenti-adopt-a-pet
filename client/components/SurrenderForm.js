...
const SurrenderForm = props => {
  ...
  const validForSubmission = () => {
    let submitErrors = {}
    const requiredFields = ["name", "phoneNumber", "email", "petName", "petTypeID", "petImageURL"]
      ...
      <form onSubmit={handleSubmit} className={formclassname}>
        ...
        <fieldset className="fieldset">
          ...
          <input
            ...
            name="petTypeID"
            value="3"
            checked={getForm.petTypeID === "3"}
            onChange={handleChange}
          />
          <label htmlFor="petTypeID">Unicorn</label>
        </fieldset>
        <label htmlFor="petImageURL">
          Please provide a link to a photo of your pet:
          <input
            id="petImageURL"
            type="text"
            name="petImageURL"
            value={getForm.petImageURL}
            onChange={handleChange}
          />
        </label>
        <fieldset className="fieldset">
          ...
          <input
            ...
            value="true"
            checked={getForm.vaccinationStatus === "true"}
            onChange={handleChange}
          />
          ...
          <input
            ...
            name="vaccinationStatus"
            value="false"
            checked={getForm.vaccinationStatus === "false"}
            onChange={handleChange}
          />
          ...
          <input
            ...
            name="vaccinationStatus"
            value="unknown"
            checked={getForm.vaccinationStatus === "unknown"}
            onChange={handleChange}
          />
