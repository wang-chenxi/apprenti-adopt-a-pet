...
class Adopter {
  constructor({ id, name, phone_number, phoneNumber, email, home_status, homeStatus, application_status, applicationStatus, pet_id, petId }) {
    this.id = id
    this.name = name
  ...
  async saveAdoptRequest() {
    try {
      ...
      const query = "INSERT INTO adoption_applications (name, phone_number, email, home_status, application_status, pet_id) VALUES ($1, $2, $3, $4, $5, $6)"
      const values = [this.name, this.phoneNumber, this.email, this.homeStatus, this.applicationStatus, this.petId]
