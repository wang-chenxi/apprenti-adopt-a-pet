...
class Surrender {
    constructor({ id, name, phone_number, phoneNumber, email, petName, pet_name, pet_image_url, petImageURL, age, vaccination_status, vaccinationStatus, pet_type_id, petTypeID, adoptionStatus, adoption_status }) {
        this.id = id
        this.name = name
    ...
    async saveSurrender() {
        try {
            ...
            console.log(this.name, this.phoneNumber, this.email, this.petName, this.petAge, this.petTypeID, this.petImageURL, this.vaccinationStatus)
    ...
    // isValid() {
    //     this.errors = {}
    //     const requiredFields = ["name", "image_url", "adoption_status", "type_id"]
    //     let isValid = true
